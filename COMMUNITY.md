...
It is **not** a public license flip. The product stays proprietary
([`LICENSE`](./LICENSE), [`OPEN_CORE.md`](./OPEN_CORE.md)). It is **not** full
BAS, automated pentest, or a Wiz / Tenable replacement.
