...
const COMMUNITY_MCP_TOOL_DEFINITIONS: CommunityMcpToolDefinition[] = [
  {
    ...
    description:
      "List the Community edition OSS/first-party validation suite (GET /api/v1/community/validation-suite). Optional scopeId narrows engines to that scope type. Not a LICENSE flip. " +
      NOT_LIVE_OFFENSIVE +
      " " +
      DENIED_NEVER_QUEUED +
