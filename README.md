...
[![License](https://img.shields.io/badge/product%20license-proprietary-lightgrey)](#license-and-open-core)
...
It is **not** a public LICENSE flip. It is **not** live Atomic / Caldera /
Metasploit / sqlmap.
...
| Product LICENSE | Usually Apache/MIT | BSD (DefectDojo OS) | Proprietary | Proprietary | **Proprietary product + upstream engine SPDX** |
...
This repo is a **proprietary product** with an **open-source engine-adapter**
surface. Read [CONTRIBUTING.md](CONTRIBUTING.md), [docs/ADAPTER_FIRST_PR.md](docs/ADAPTER_FIRST_PR.md),
...
**This is not an OSI license flip.** Root [`LICENSE`](./LICENSE) stays
**proprietary** until founder and counsel explicitly change it. Option A
(Apache-2.0 core + commercial edge) is the *recommended model*, not a completed
action. See [OPEN_CORE.md](OPEN_CORE.md).

| Layer | License | Notes |
| --- | --- | --- |
| Product (control plane, UI, API, worker, runner, first-party modules) | Proprietary | Evaluation / customer agreement only |
| Third-party engines and Node dependencies | Their SPDX | [licenses/THIRD_PARTY_NOTICES.md](licenses/THIRD_PARTY_NOTICES.md) |
| Community edition | Product *slice*, not a license | Feature gates + pack freeze + honest claims |
