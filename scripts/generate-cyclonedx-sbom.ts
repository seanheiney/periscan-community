      ...
      properties: [
        {
          ...
          value:
            "Node dependency inventory. Product LICENSE remains proprietary; this document does not relicense Periscan or claim redistribution of optional copyleft engines."
        },
        {
